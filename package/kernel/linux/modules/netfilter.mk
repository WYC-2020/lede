...
define KernelPackage/nf-flow
  ...
  FILES:= \
	...
	$(LINUX_DIR)/net/netfilter/nf_flow_table_hw.ko@eq5.4
  AUTOLOAD:=$(call AutoProbe,nf_flow_table nf_flow_table_hw@eq5.4)
endef
...
define KernelPackage/nft-offload
  ...
  KCONFIG:= \
	...
	CONFIG_NF_FLOW_TABLE_IPV4@lt6.1 \
	CONFIG_NF_FLOW_TABLE_IPV6@lt6.1 \
