...
define KernelPackage/mdio-devres
  ...
  DEPENDS:=@!LINUX_5_4 +kmod-libphy +(TARGET_armvirt||TARGET_bcm27xx_bcm2708||TARGET_tegra):kmod-of-mdio
...
define KernelPackage/mdio-gpio
  ...
  DEPENDS:=+kmod-libphy @GPIO_SUPPORT +kmod-of-mdio
  KCONFIG:= \
	CONFIG_MDIO_BITBANG \
	CONFIG_MDIO_GPIO
  FILES:= \
...
define KernelPackage/switch-rtl8366-smi
  ...
  DEPENDS:=@GPIO_SUPPORT +kmod-swconfig +kmod-of-mdio
